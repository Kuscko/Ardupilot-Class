# Installation Scripts & Troubleshooting — Agent Onboarding

## Purpose
Maintain and update scripts for installing ArduPilot (Plane 4.5.7). Document all changes, fixes, and issues (especially with Python packages) during onboarding.
...
---
**Keep this README updated as you maintain and improve installation scripts.**